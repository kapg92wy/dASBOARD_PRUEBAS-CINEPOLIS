...
async function renderMisAsignadas(container) {
  container.innerHTML =
    ...
    + '<div class="filters">'
    + '<span class="flabel">Estado</span><select id="faEstado" onchange="filtrarMisAsignadas()"><option value="">Todos</option><option>Abierta</option><option>En proceso</option><option>Resuelta</option></select>'
